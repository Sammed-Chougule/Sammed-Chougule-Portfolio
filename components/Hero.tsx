      ...
      <div className="container mx-auto px-6 md:px-12 max-w-6xl relative z-10">
        <div className="flex flex-col items-start max-w-3xl">
          ...
          >
            <a
              href="#projects"
              className="group px-8 py-3 bg-slate-900 text-white font-medium rounded-xl hover:bg-slate-700 hover:shadow-lg hover:shadow-slate-300 transition-all flex items-center gap-2"
            >
              Check out my work
            ...
            <a
              ...
              className="px-8 py-3 bg-white border border-slate-300 text-slate-700 font-medium rounded-xl hover:border-slate-500 hover:text-slate-900 hover:-translate-y-0.5 hover:shadow-md transition-all flex items-center gap-2"
            >
              Resume
              <Download size={18} />
            </a>
